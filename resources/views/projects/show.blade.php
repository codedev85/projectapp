...
<div class="jumbotron">
     <h1 class="project-heading-color">{{$project->name}}</h1>
    <p class="project-heading-color">{{$project->description}} </p>
    <h5 class="project-heading-color"><b>Project schedule/Start Date</b></h5>
      
      @if($project->date != null)
        <p>{{$project->days}}days ({{$project->created_at}})</p>
      @else
        <p class="project-heading-color">No specified number of days.</p>
      @endif
